...
const locations=[
  ...
  {
    name:"store",
    "button text":["Buy 10 health (10 gold)", "Buy weapon(25 gold)", "Go to town square"],
...
function update(location){
  ...
  button1.onlcik=location["button functions"][0];
...
function buyWeapon() 
{
  if (currentWeapon < weapons.length-1)
  {
    if(gold>=25)
    {
      ...
      text.innerText=text.innerText+"You now have a "+newWeapon+".";
...
function defeatMonster() {
  gold+=Math.floor(monsters(fightinh).level*6.7);
